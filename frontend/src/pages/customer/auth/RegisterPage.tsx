...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full max-w-lg lg:max-w-5xl bg-[#151517]/90 p-6 sm:p-8 md:p-10 rounded-sm shadow-2xl backdrop-blur-md flex flex-col lg:flex-row gap-8 lg:gap-10 border border-gray-800 animate-in fade-in zoom-in-95 duration-300">
        ...
        <ul className="space-y-6 text-md">
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Sử dụng tên thật để thuận tiện cho việc nhận hàng và bảo hành,
                tối thiểu 2 ký tự.
              </p>
            </div>
          </li>
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Hệ thống sẽ gửi hóa đơn và thông báo trạng thái đơn hàng qua
                email này.
              </p>
            </div>
          </li>
          <li className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Tối thiểu 8 ký tự, bao gồm ít nhất một chữ hoa, một chữ thường
                và một chữ số.
              </p>
            </div>
          </li>
