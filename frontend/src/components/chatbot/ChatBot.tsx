  ...
  return (
    ...
    >
      {isOpen && (
        <div
          className={cn(
            ...
            "sm:static sm:z-auto sm:h-[500px] sm:w-[400px]",
        ...
        >
          ...
          <form
            ...
            className="p-3 bg-white border-t border-gray-100 flex gap-2 shrink-0 pb-safe" // pb-safe để tránh nút home ảo trên iPhone
          >
            <input
              ref={inputRef}
              type="text"
              ...
              className="flex-1 px-4 py-3 sm:py-2 text-base sm:text-sm bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50"
            />
            <button
              type="submit"
              disabled={!inputValue.trim() || isStreaming}
              className="bg-red-600 text-white p-3 sm:p-2.5 rounded-full hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex-shrink-0"
            >
              {isStreaming ? (
      ...
      <button
        ...
        className={cn(
          "h-13 w-13 rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer",
